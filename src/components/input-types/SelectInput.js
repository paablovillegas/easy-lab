    ...
    return (
        <div>
            ...
            <div className="relative">
                ...
                <select className="appearance-none bg-gray-100 text-gray-600 rounded shadow-sm py-2 px-11 w-full transition duration-300 focus:outline-none focus:shadow-md">
